...
export function CheckoutClient() {
  ...
  // Email is optional now — kept only for the confirmation email/receipt.
      ...
      <form onSubmit={handleSubmit} className="space-y-10 lg:order-1">
        ...
        <fieldset>
          ...
          <div className="space-y-4">
            ...
            {/* Email — optional, just for the receipt */}
            <div>
              ...
              <p className="mt-2 text-xs text-fg-faint">
                Add it if you&apos;d like an email receipt — we&apos;ll confirm
                every order on WhatsApp regardless.
              </p>
            </div>
